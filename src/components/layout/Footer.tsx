...
export function Footer() {
  return (
    <footer className="border-t border-border/50 bg-background/50 backdrop-blur-sm py-8 md:py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col items-center md:items-start gap-2">
            ...
            <p className="text-sm text-muted-foreground max-w-sm text-center md:text-left">
              Built to empower individuals to make massive impact through intelligent AI insights.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end gap-4">
            ...
            <div className="flex items-center gap-4">
              <Link 
                ...
                className="p-2 rounded-full bg-muted/50 hover:bg-emerald-100 hover:text-emerald-700 transition-colors"
              >
              ...
              <Link 
                href="mailto:iamhriturajsaha@gmail.com" 
                className="p-2 rounded-full bg-muted/50 hover:bg-emerald-100 hover:text-emerald-700 transition-colors"
              >
        ...
        <div className="mt-8 pt-8 border-t border-border/50 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          <p>© {new Date().getFullYear()} EcoTrace AI. All rights reserved.</p>
